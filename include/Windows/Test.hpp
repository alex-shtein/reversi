...
namespace game
{
    ...
    /**
     * @brief Вложенный класс Test представляет собой окно выхода из игры.
     */
    class Test : public PopWindow
    {
    private:
    ...
    public:
        Test() = default; ///< Конструктор по умолчанию для класса Test

        /**
         * @brief Конструктор класса Test.
         * 
         * @param gameStack Указатель на игровой стек.
         */
        Test(game::GameStack* gameStack);
